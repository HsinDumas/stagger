...
[![chinese](https://img.shields.io/badge/chinese-中文文档-brightgreen)](https://github.com/HsinDumas/smart-doc-gradle-plugin/blob/master/README_CN.md)
...
![smart-doc-gradle-plugin](https://raw.githubusercontent.com/HsinDumas/smart-doc-gradle-plugin/master/images/idea.png)
...
## Who is using
These are only part of the companies using `smart-doc`, for reference only. If you are using `smart-doc`, please [add your company here](https://github.com/HsinDumas/stagger/issues/12) to tell us your scenario to make smart-doc better.
