...
package gradle.kotlin.dsl.plugins._3b99df7bc04ba980b91c0fc2c0bb4ce4
...
/**
 * The `io.spring.javaformat` plugin implemented by [io.spring.javaformat.gradle.SpringJavaFormatPlugin].
 */
internal
val `IoSpringPluginGroup`.`javaformat`: PluginDependencySpec
    get() = plugins.id("io.spring.javaformat")
