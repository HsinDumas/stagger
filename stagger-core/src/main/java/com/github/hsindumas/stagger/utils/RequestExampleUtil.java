...
public class RequestExampleUtil {
     ...
     */
    public static ApiRequestExample setExampleBody(
    ...
    private static boolean isPostOrPut(String methodType) {
        return Methods.POST.getValue().equals(methodType)
    ...
    private static String constructUrl(
            String path, Map<String, String> pathParamsMap, Map<String, String> queryParamsMap, String serverUrl) {
     ...
     */
    private static ApiRequestExample handleGetDeleteRequest(
            ApiRequestExample requestExample,
            String methodType,
            String url,
            String contentType,
            List<ApiReqParam> reqHeaderList) {
     ...
     */
    private static ApiRequestExample handlePostPutRequest(
            ApiRequestExample requestExample,
            String methodType,
            String url,
            String contentType,
