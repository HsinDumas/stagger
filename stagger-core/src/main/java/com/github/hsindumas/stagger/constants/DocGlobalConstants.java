...
public interface DocGlobalConstants {
     ...
     * Language.
     */
    String DOC_LANGUAGE = "stagger_language";
     ...
     * object list warning.
     */
    String GENERIC_LIST_WARNING =
            "{\"warning\":\"Using java.util.Object in a List instead of a specific generic type is not recommended."
                    + " Smart-doc cannot display the correct generics. Please specify the generic type for better"
