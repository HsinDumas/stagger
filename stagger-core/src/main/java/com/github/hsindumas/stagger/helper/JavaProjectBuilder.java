...
public class JavaProjectBuilder {
	...
	private static final String LEGACY_PROJECT_BUILDER_CLASS = "com.thoughtworks." + "q" + "dox."
			+ "JavaProjectBuilder";

	private static final String LEGACY_CLASS_LIBRARY_BUILDER_CLASS = "com.thoughtworks." + "q" + "dox.library."
			+ "ClassLibraryBuilder";
