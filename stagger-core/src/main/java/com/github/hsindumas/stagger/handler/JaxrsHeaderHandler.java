        ...
        for (Object javaParameter : parameters) {
            ...
            for (Object annotation : annotations) {
                ...
                if (JakartaJaxrsAnnotations.JAX_HEADER_PARAM_FULLY.equals(annotationName)
                    ...
                    String typeName =
                            DocUtil.getParameterTypeValue(javaParameter).toLowerCase();
                    ...
                    if (enumType) {
                        ...
                        if (hasJavaEnumClass) {
                            EnumInfoAndValues enumInfoAndValue =
                                    JavaClassUtil.getEnumInfoAndValue(javaClass, projectBuilder, Boolean.FALSE);
                            if (Objects.nonNull(enumInfoAndValue)) {
                                String enumValue =
                                        StringUtil.removeDoubleQuotes(String.valueOf(enumInfoAndValue.getValue()));
