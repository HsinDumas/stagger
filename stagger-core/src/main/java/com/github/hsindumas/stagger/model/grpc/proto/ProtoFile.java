 ...
 * under the License.
 */
package com.github.hsindumas.stagger.model.grpc.proto;
...
public class ProtoFile implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return hasEnums == protoFile.hasEnums
                && hasExtensions == protoFile.hasExtensions
                && hasMessages == protoFile.hasMessages
                && hasServices == protoFile.hasServices
                && Objects.equals(name, protoFile.name)
                && Objects.equals(description, protoFile.description)
                && Objects.equals(packageName, protoFile.packageName)
                && Objects.equals(enums, protoFile.enums)
                && Objects.equals(extensions, protoFile.extensions)
                && Objects.equals(messages, protoFile.messages)
