...
public class JaxrsPathHandler {
     ...
     */
    private static final Set<String> ANNOTATION_NAMES = Collections.unmodifiableSet(Stream.of(
                    JakartaJaxrsAnnotations.JAXB_DELETE_FULLY,
                    JakartaJaxrsAnnotations.JAX_PUT_FULLY,
                    JakartaJaxrsAnnotations.JAX_GET_FULLY,
                    JakartaJaxrsAnnotations.JAX_POST_FULLY,
                    JakartaJaxrsAnnotations.JAX_PATCH_FULLY,
                    JakartaJaxrsAnnotations.JAX_HEAD_FULLY,
                    JAXRSAnnotations.JAXB_DELETE_FULLY,
                    JAXRSAnnotations.JAX_PUT_FULLY,
                    JAXRSAnnotations.JAX_GET_FULLY,
                    JAXRSAnnotations.JAX_POST_FULLY,
                    JAXRSAnnotations.JAXB_PATCH_FULLY,
                    JAXRSAnnotations.JAXB_HEAD_FULLY)
     ...
     */
    public JaxrsPathMapping handle(
            ProjectDocConfigBuilder projectBuilder, String baseUrl, Object method, String mediaType) {
        ...
        JaxrsPathMapping jaxrsPathMapping =
                getJaxbPathMapping(projectBuilder, baseUrl, method, shortUrl, serverUrl, contextPath);
        if (jaxrsPathMapping != null) {
            return jaxrsPathMapping
     ...
     * @return A JaxrsPathMapping object containing the processed path information
     */
    private JaxrsPathMapping getJaxbPathMapping(
        ...
        if (Objects.nonNull(shortUrl)) {
            ...
            if (urls.size() > 1) {
                ...
                shortUrl = DocUrlUtil.getMvcUrls(
                        DocGlobalConstants.EMPTY, contextPath + DocGlobalConstants.PATH_DELIMITER + baseUrl, urls);
            }
