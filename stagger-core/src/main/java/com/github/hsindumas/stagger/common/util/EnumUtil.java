...
public final class EnumUtil {
    ...
    public static <T extends EnumDictionary> List<T> getEnumInformation(
            Class<?> enumClass, String codeField, String descField) {
        ...
        if (StringUtil.isEmpty(codeField) || StringUtil.isEmpty(descField)) {
            throw new RuntimeException(enumClass.getCanonicalName()
                    + ":Please specify the code field name of the dictionary enumeration class and the field"
                    + " name that describes the dictionary code information");
        }
