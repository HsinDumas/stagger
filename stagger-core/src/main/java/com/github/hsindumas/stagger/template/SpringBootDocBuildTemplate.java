...
public class SpringBootDocBuildTemplate implements IDocBuildTemplate<ApiDoc>, IWebSocketDocBuildTemplate<WebSocketDoc>,
	...
	public FrameworkAnnotations registeredAnnotations() {
		...
		exceptionAdviceAnnotations.put("org.springframework.web.bind.annotation.ControllerAdvice",
		...
		exceptionAdviceAnnotations.put("org.springframework.web.bind.annotation.RestControllerAdvice",
				restControllerAdviceAnnotation);
	...
	private Map<String, MappingAnnotation> buildSpringMappingAnnotations() {
		...
		MappingAnnotation postMapping = this.createMapping(SpringMvcAnnotations.POST_MAPPING, Methods.POST.getValue(),
				"org.springframework.web.bind.annotation.PostMapping", pathProps, consumes, produces, method, params);
		...
		MappingAnnotation getMapping = this.createMapping(SpringMvcAnnotations.GET_MAPPING, Methods.GET.getValue(),
				"org.springframework.web.bind.annotation.GetMapping", pathProps, consumes, produces, method, params);
		...
		MappingAnnotation putMapping = this.createMapping(SpringMvcAnnotations.PUT_MAPPING, Methods.PUT.getValue(),
				"org.springframework.web.bind.annotation.PutMapping", pathProps, consumes, produces, method, params);
		...
		MappingAnnotation patchMapping = this.createMapping(SpringMvcAnnotations.PATCH_MAPPING,
				Methods.PATCH.getValue(), "org.springframework.web.bind.annotation.PatchMapping", pathProps, consumes,
				produces, method, params);
		...
		MappingAnnotation deleteMapping = this.createMapping(SpringMvcAnnotations.DELETE_MAPPING,
				Methods.DELETE.getValue(), "org.springframework.web.bind.annotation.DeleteMapping", pathProps, consumes,
				produces, method, params);
		this.putMappingAnnotation(mappingAnnotations, deleteMapping);

		// @HttpExchange and typed variants for Spring HTTP interfaces
		MappingAnnotation httpExchange = this.createMapping(SpringMvcAnnotations.HTTP_EXCHANGE, null,
				SpringMvcAnnotations.HTTP_EXCHANGE_FULLY, exchangePathProps, "contentType", "accept", method, params);
		this.putMappingAnnotation(mappingAnnotations, httpExchange);

		MappingAnnotation getExchange = this.createMapping(SpringMvcAnnotations.GET_EXCHANGE, Methods.GET.getValue(),
				SpringMvcAnnotations.GET_EXCHANGE_FULLY, exchangePathProps, "contentType", "accept", method, params);
		this.putMappingAnnotation(mappingAnnotations, getExchange);

		MappingAnnotation postExchange = this.createMapping(SpringMvcAnnotations.POST_EXCHANGE, Methods.POST.getValue(),
				SpringMvcAnnotations.POST_EXCHANGE_FULLY, exchangePathProps, "contentType", "accept", method, params);
		this.putMappingAnnotation(mappingAnnotations, postExchange);

		MappingAnnotation putExchange = this.createMapping(SpringMvcAnnotations.PUT_EXCHANGE, Methods.PUT.getValue(),
				SpringMvcAnnotations.PUT_EXCHANGE_FULLY, exchangePathProps, "contentType", "accept", method, params);
		this.putMappingAnnotation(mappingAnnotations, putExchange);

		MappingAnnotation patchExchange = this.createMapping(SpringMvcAnnotations.PATCH_EXCHANGE,
				Methods.PATCH.getValue(), SpringMvcAnnotations.PATCH_EXCHANGE_FULLY, exchangePathProps, "contentType",
				"accept", method, params);
		this.putMappingAnnotation(mappingAnnotations, patchExchange);

		MappingAnnotation deleteExchange = this.createMapping(SpringMvcAnnotations.DELETE_EXCHANGE,
				Methods.DELETE.getValue(), SpringMvcAnnotations.DELETE_EXCHANGE_FULLY, exchangePathProps, "contentType",
				"accept", method, params);
	 ...
	 */
	private MappingAnnotation createMapping(String annotationName, String methodType, String annotationFullyName,
			String[] pathProps, String consumes, String produces, String method, String params) {
	...
	private void putMappingAnnotation(Map<String, MappingAnnotation> mappingAnnotations,
