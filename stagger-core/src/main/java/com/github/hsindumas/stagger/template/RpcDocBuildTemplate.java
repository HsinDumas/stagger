...
public class RpcDocBuildTemplate
     ...
     * information.
     */
    private void handleJavaApiDoc(
            Object cls,
            List<RpcApiDoc> apiDocList,
            List<RpcJavaMethod> apiMethodDocs,
            int order,
        ...
        for (Object annotation : annotations) {
            ...
            if (Objects.nonNull(versionValue)) {
                String version =
                        DocUtil.resolveAnnotationValue(builder.getApiConfig().getClassLoader(), versionValue);
            ...
            if (Objects.nonNull(protocolValue)) {
                String protocol =
                        DocUtil.resolveAnnotationValue(builder.getApiConfig().getClassLoader(), protocolValue);
            ...
            if (Objects.nonNull(interfaceNameValue)) {
                String interfaceName =
                        DocUtil.resolveAnnotationValue(builder.getApiConfig().getClassLoader(), interfaceNameValue);
