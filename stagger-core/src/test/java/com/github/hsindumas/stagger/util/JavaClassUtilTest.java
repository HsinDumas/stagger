...
public class JavaClassUtilTest {
    ...
    void shouldReturnImplementedInterfacesFromAccessor() {
        ...
        InterfaceMetadata javaClass =
                new InterfaceMetadata(Collections.singletonList(interfaceType), Collections.emptyList());
    ...
    void shouldReturnInterfaceClassesFromAccessor() {
        ...
        InterfaceMetadata javaClass =
                new InterfaceMetadata(Collections.emptyList(), Collections.singletonList(interfaceClass));
