...
public class MojoUtils {
     ...
     */
    public static ApiConfig buildConfig(
            File configFile,
            String projectName,
            MavenProject project,
            ProjectBuilder projectBuilder,
            MavenSession mavenSession,
            List<String> projectArtifacts,
            Boolean increment,
            Log log)
     ...
     * addSourcePath
     */
    private static void addSourcePaths(
            MavenProject project,
            ProjectBuilder projectBuilder,
            MavenSession mavenSession,
            ApiConfig apiConfig,
    ...
    private static void buildModules(
        ...
        for (Map.Entry<String, MavenProject> mavenProject : referenceMavenProject.entrySet()) {
            if (log.isDebugEnabled()) {
                log.debug(project.getName() + " references mavenProject is: "
                        + mavenProject.getValue().getName());
            }
     ...
     */
    public static void addByProjectReference(
            Map<String, MavenProject> referenceMavenProject, Map<String, MavenProject> sourceProject) {
     ...
     * @return Map
     */
    public static Map<String, MavenProject> collectProject(
            MavenProject project, ProjectBuilder projectBuilder, MavenSession session, Log log) {
